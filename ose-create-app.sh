...
oc new-app java \
   ...
   --env=JAVA_OPTIONS='-Dquarkus.datasource.url=jdbc:mysql://mysql.nmquarkus.svc.cluster.local/berlin -Dquarkus.datasource.username=niko -Dquarkus.datasource.password=niko'
